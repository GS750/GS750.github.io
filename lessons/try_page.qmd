...
<div class="drag-exercise" {=html} style="font-family:sans-serif;">
  ...
  <script>
    function allowDrop(ev) {
      ev.preventDefault();
      // only allow drop if target is a drop-box
    ...
    function drop(ev) { 
      ...
      // make sure we drop into the correct box (not another item)
      while(!target.classList.contains('drop-box')) {
        target = target.parentElement;
      }
      target.appendChild(document.getElementById(ev.dataTransfer.getData("text"))); 
    }
