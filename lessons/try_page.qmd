...
<div class="drag-exercise" {=html} style="font-family:sans-serif;">
  ...
  <script>
    ...
    function allowDrop(ev) {
      // only allow if the drop target *is* a drop-box
      let target = ev.target;
      while (target && !target.classList.contains('drop-box')) {
    ...
    // Drop: always find the nearest drop-box ancestor
    function drop(ev) {
      ev.preventDefault();
      ...
      // only drop if it's a valid drop-box
    ...
    document.querySelectorAll('.drag-item').forEach(div =>
