...
<div class="drag-exercise" {=html}>
  ...
  <div class="button-row">
    ...
    <button onclick="resetExercise()" style="background-color:#6c757d;">Reset</button>
  </div>

  <div id="result"></div>

  <script>
    // Allow drop only on dropzones
    function allowDrop(ev) {
    ...
    // Reset exercise: empty the drop zones
    function resetExercise() {
      const zones = ["treatment", "outcome"];
      zones.forEach(id => {
        const zone = document.getElementById(id);
        // Remove everything except the <strong> label
