...
<div class="drag-exercise" {=html}>
  <div style="display:flex; justify-content:space-between; width:600px;">
    ...
    <div id="left" style="width:45%;">
      <div draggable="true" id="item1" style="padding:5px; margin:5px; border:1px solid black; cursor:grab;">Student got new method</div>
      <div draggable="true" id="item2" style="padding:5px; margin:5px; border:1px solid black; cursor:grab;">Test score after intervention</div>
      <div draggable="true" id="item3" style="padding:5px; margin:5px; border:1px solid black; cursor:grab;">Patient received medication</div>
      <div draggable="true" id="item4" style="padding:5px; margin:5px; border:1px solid black; cursor:grab;">Blood pressure after treatment</div>
    </div>

    <!-- Right column: droppable boxes -->
    <div id="right" style="width:45%;">
      <div id="treatment" ondrop="drop(event)" ondragover="allowDrop(event)" 
           style="min-height:120px; border:2px dashed blue; margin-bottom:10px; padding:5px; overflow:auto; display:flex; flex-direction:column; gap:5px;">
        <strong>Treatment</strong>
      </div>
      <div id="outcome" ondrop="drop(event)" ondragover="allowDrop(event)" 
           style="min-height:120px; border:2px dashed green; padding:5px; overflow:auto; display:flex; flex-direction:column; gap:5px;">
  ...
  <button onclick="checkAnswer()" style="margin-top:10px;">Check Answers</button>
  ...
  <script>
    ...
    // Drop event: append the dragged item to the box
    function drop(ev) { 
      ev.preventDefault(); 
      ev.target.appendChild(document.getElementById(ev.dataTransfer.getData("text"))); 
    }

    // Attach dragstart event to each item
