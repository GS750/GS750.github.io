...
<!-- } -->
<!-- </script> -->
<div id="question" style="font-family: sans-serif; max-width: 500px; margin: 20px auto; padding: 20px; border: 2px solid #4A90E2; border-radius: 10px; background-color: #F0F8FF;">
  <p style="font-size: 16px;">Suppose a randomized experiment gives the following group averages:</p>
  <ul style="font-size: 16px; line-height: 1.5;">
    <li><strong>Treatment Group average:</strong> 89.3</li>
    <li><strong>Control Group average:</strong> 81.4</li>
  </ul>
  <p style="font-size: 16px;">What is the difference between the Treatment and Control group averages?</p>
  <input type="number" id="answer" placeholder="Enter your answer" style="font-size: 16px; padding: 5px; width: 100px; margin-right: 10px; border-radius: 5px; border: 1px solid #ccc;">
